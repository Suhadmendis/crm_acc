...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Search Direct Receipt</title>

        <script language="JavaScript" src="js/receipt_entry.js"></script>
        <!-- Bootstrap core CSS -->
    ...
    <body>
        <div class="container">
            ...
            <div id="filt_table">  <table class="table table-bordered">
                    ...
                    $sql = "select REFNO, BDATE,BARER,AMOUNT,ID from recmas ORDER BY ID desc limit 50";
