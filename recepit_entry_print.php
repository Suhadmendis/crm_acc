...
$sql = "Select * from recmas where tmp_no='" . $_GET['tmp_no'] . "'";
...
$html .="<body> 
        ...
        <table   style='width: 660px;' class='table1'>
           ...
           <tr>
            ...
            <tr>
              <th colspan='4' ><center>DIRECT RECEIPT</th>
...
$sql = "Select L_CODE,C_NAME,curamo,L_FLAG1 from view_ledger where l_refno='" . $row["REFNO"] . "' order by L_FLAG1 desc";
$mflag = "";
$mtot =0;
foreach ($conn->query($sql) as $row1) {

if ($mflag != $row1['L_FLAG1']) {    
if ($mflag != "") {
