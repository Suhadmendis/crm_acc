...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Search Debit Note</title>

        <script language="JavaScript" src="js/debit_note.js"></script>
        <!-- Bootstrap core CSS -->
    ...
    <body>
        <div class="container">
            ...
            <div id="filt_table">  <table class="table table-bordered">
                    ...
                    $sql = "select C_REFNO, C_DATE,C_CODE,c_name,C_PAYMENT,ID from deb ORDER BY C_REFNO desc limit 50";
