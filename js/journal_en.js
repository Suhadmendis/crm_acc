...
function add_tmp(cdata) {
    ...
    if ((document.getElementById('txt_entno').value != "") && (document.getElementById('tmpno').value != "")) {
        ...
        if (cdata == "CN1") {
            ...
            url = url + "&CN1=" + document.getElementById('CN1_1').value;
            url = url + "&CN2=" + document.getElementById('CN1_2').value;
            url = url + "&CN3=" + document.getElementById('CN1_3').value;
            ...
            url = url + "&CN1=" + document.getElementById('CN2_1').value;
            url = url + "&CN2=" + document.getElementById('CN2_2').value;
            url = url + "&CN3=" + document.getElementById('CN2_3').value;
...
function cal(val,form) {
    document.getElementById('in_text').value = val;
    document.getElementById('type').value = form;
    document.getElementById('per_text').focus();
    
}

function setcal(event) {
    
       var amount = parseFloat(document.getElementById("in_text").value) || 0;
    var per = parseFloat(document.getElementById("per_text").value) || 0;
    ...
    if (x === 13) {
        if (type == "CN1") {
            document.getElementById('itemPrice1').value = cal;
        }else{
            document.getElementById('itemPrice').value = cal;
        }
