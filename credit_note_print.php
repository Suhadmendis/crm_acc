...
$sql = "Select * from cred where tmp_no='" . $_GET['tmp_no'] . "'";
...
$html .="<body> 
        ...
        <table   style='width: 660px;' class='table1'>
            ...
            <tr>
              <th colspan='4' ><center>CREDIT NOTE</th>
            ...
            <tr>
                ...
                <td>" . $row['C_CODE'] . "</td>
                <td>&nbsp;</td>
                <th class='right'>CRN No</th>   
                <td  style='width: 120px;' class='right'>" . $row['C_REFNO'] . "</td>   
            </tr>
...
$pdf = $dompdf->output();
$pdf_name = str_replace("/", "-", intval(substr($row['C_REFNO'],5,8))) ."_" . (date('Ymd g i'));
